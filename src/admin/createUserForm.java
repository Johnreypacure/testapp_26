...
public boolean duplicateCheck(){
        ...
        try{
           String query = "SELECT * FROM table_user  WHERE u_username = '" + un.getText() + "' or u_email = '" + em.getText() + "'";
...
public boolean updateCheck(){
        ...
        dbConnector dbc = new dbConnector();
        try{
           String query = "SELECT * FROM table_user ( WHERE u_username = '" + un.getText() + "' OR u_email = '" + em.getText() + "')AND u_id != '"+uid.getText()+"'";
            ResultSet resultSet = dbc.getData(query);
           if(resultSet.next()){
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if(fn.getText().isEmpty()||ln.getText().isEmpty()||em.getText().isEmpty()||un.getText().isEmpty()||pass.getText().isEmpty()){
            ...
            if(dbc.insertData("INSERT INTO table_user(u_fname,u_lname,u_email,u_username,u_password,u_type,u_status)"
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
       ...
       dbConnector dbc = new dbConnector();
       dbc.updateData("UPDATE table_user SET u_fname = '"+fn.getText()+"',u_lname = '"+ln.getText()+"',"
